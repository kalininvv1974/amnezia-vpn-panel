...
Веб-панель управления для **AmneziaVPN / AmneziaWG 3.x** с входом по форме (логин/пароль), списком клиентов, трафиком, QR‑кодами и скачиванием `.conf`. Дизайн — в стиле wg‑easy, работает на nginx + Node.js.
